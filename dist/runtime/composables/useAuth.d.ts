...
import type { SessionData, SessionLastRefreshedAt, SessionStatus } from './useAuthState';
/**
 ...
 */
declare const getProviders: () => Promise<Record<any, Omit<AppProvider, "options"> | undefined>>;
/**
 ...
 */
declare const getSession: (getSessionOptions?: GetSessionOptions) => Promise<any>;
/**
...
declare const _default: () => useAuthReturn;
