export declare const getRequestURL: (includePath?: boolean) => string;
export declare const joinPathToApiURL: (path: string) => string;
/**
 ...
 */
export declare const determineCallbackUrl: <T extends string | Promise<string>>(authConfig: any, getOriginalTargetPath: () => T) => string | T | undefined;
